...
class StudentRepresentative(Base):
    ...
    relationship_type:   Mapped[str|None] = mapped_column(String,   nullable=True)    # "padre","madre","abuelo","tío","otro"
    ...
    def __repr__(self) -> str:
        return f"<StudentRep student={self.student_id} person={self.person_id} primary={self.is_primary_notify}>"
